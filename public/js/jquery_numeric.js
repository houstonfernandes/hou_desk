...
$(".integer").numeric(false, function () {
  alert("Somente numeros inteiros.");this.value = "";this.focus();
});
$(".positive").numeric({ negative: false }, function () {
  alert("Sem valor negativo.");this.value = "";this.focus();
});
$(".positive-integer").numeric({ decimal: false, negative: false }, function () {
  alert("Somente números inteiros positivos");this.value = "";this.focus();
});
